...
CREATE TABLE IF NOT EXISTS public.dp_data (
    ...
    data_rows BIGINT
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.564091-04:00',
                status = 'published',
                tag = 'icd',
...
* **Dimensions**: 5 columns / 12,597 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.564855-04:00',
                status = 'published',
                tag = 'icd',
...
* **Dimensions**: 17 columns / 35,459 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.565224-04:00',
                status = 'published',
                tag = 'icd',
...
* **Dimensions**: 12 columns / 12,597 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.565579-04:00',
                status = 'published',
                tag = 'icd',
...
* **Dimensions**: 7 columns / 17,799 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.565933-04:00',
                status = 'published',
                tag = 'wbd',
...
* **Dimensions**: 10 columns / 182 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.566291-04:00',
                status = 'published',
                tag = 'icd,wbd',
...
* **Dimensions**: 11 columns / 6,502 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.566644-04:00',
                status = 'published',
                tag = 'cmea',
...
* **Dimensions**: 3 columns / 143 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.566999-04:00',
                status = 'published',
                tag = 'icd,cmea',
...
* **Dimensions**: 3 columns / 1,653 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.567348-04:00',
                status = 'published',
                tag = 'wva',
...
* **Dimensions**: 10 columns / 85 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.567685-04:00',
                status = 'published',
                tag = 'icd,wva',
...
* **Dimensions**: 6 columns / 2,384 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.568026-04:00',
                status = 'published',
                tag = 'wva',
...
* **Dimensions**: 3 columns / 65 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.568348-04:00',
                status = 'published',
                tag = 'icd,wva',
...
* **Dimensions**: 4 columns / 4,442 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.568670-04:00',
                status = 'published',
                tag = 'cghr',
...
* **Dimensions**: 3 columns / 36 rows',
            ...
            SET
                ...
                is_spatial = 'False',
                "permission" = 'user',
                last_updated_date = '2023-07-11 23:48:06.569019-04:00',
                status = 'published',
                tag = 'icd,cghr',
...
* **Dimensions**: 4 columns / 6,411 rows',
            ...
            SELECT 'ICD-10 Codes', 'icd10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.564091-04:00', 'published', 'icd', 'International Classification of Diseases Revision 10 (ICD-10) data from the World Health Organization (WHO).
...
* **Dimensions**: 5 columns / 12,597 rows', 'main', 'support@openmortality.org', '5', '12597'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-11 Codes', 'icd11_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.564855-04:00', 'published', 'icd', 'International Classification of Diseases Revision 11 (ICD-11) data from the World Health Organization (WHO).
...
* **Dimensions**: 17 columns / 35,459 rows', 'main', 'support@openmortality.org', '17', '35459'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to ICD-11 Code Mappings', 'icd10_icd11_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.565224-04:00', 'published', 'icd', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) codes to [ICD-11](https://openmortality.org/data/icd11_v1) codes.
...
* **Dimensions**: 12 columns / 12,597 rows', 'supplementary', 'support@openmortality.org', '12', '12597'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-11 to ICD-10 Code Mappings', 'icd11_icd10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.565579-04:00', 'published', 'icd', 'Mappings to convert from [ICD-11](https://openmortality.org/data/icd11_v1) codes to [ICD-10](https://openmortality.org/data/icd10_v1) codes.
...
* **Dimensions**: 7 columns / 17,799 rows', 'supplementary', 'support@openmortality.org', '7', '17799'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'WBD-10 Codes', 'wbd10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.565933-04:00', 'published', 'wbd', 'Wilson''s Burden of Disease for ICD-10 (WBD-10) data from the Centre for Global Health Research (CGHR).
...
* **Dimensions**: 10 columns / 182 rows', 'main', 'support@openmortality.org', '10', '182'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to WBD-10 Code Mappings', 'icd10_wbd10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.566291-04:00', 'published', 'icd,wbd', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) codes to [WBD-10](https://openmortality.org/data/wbd10_v1) codes.
...
* **Dimensions**: 11 columns / 6,502 rows', 'supplementary', 'support@openmortality.org', '11', '6502'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'CMEA-10 Codes', 'cmea10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.566644-04:00', 'published', 'cmea', 'Central Medical Evaluation Agreement for ICD-10 (CMEA-10) code blocks from the Centre for Global Health Research (CGHR).
...
* **Dimensions**: 3 columns / 143 rows', 'main', 'support@openmortality.org', '3', '143'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to CMEA-10 Mappings', 'icd10_cmea10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.566999-04:00', 'published', 'icd,cmea', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) codes to [CMEA-10](https://openmortality.org/data/cmea10_v1) code blocks.
...
* **Dimensions**: 3 columns / 1,653 rows', 'supplementary', 'support@openmortality.org', '3', '1653'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'WVA-2016 Codes', 'wva2016_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.567348-04:00', 'published', 'wva', 'World Health Organization Verbal Autopsy 2016 (WVA-2016) codes that generalize ICD-10 codes into mortality relevant codes.
...
* **Dimensions**: 10 columns / 85 rows', 'main', 'support@openmortality.org', '10', '85'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to WVA-2016 Code Mappings', 'icd10_wva2016_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.567685-04:00', 'published', 'icd,wva', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) codes to [WVA-2016](https://openmortality.org/data/wva2016_v1) codes.
...
* **Dimensions**: 6 columns / 2,384 rows', 'supplementary', 'support@openmortality.org', '6', '2384'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'WVA-2022 Codes', 'wva2022_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.568026-04:00', 'published', 'wva', 'World Health Organization Verbal Autopsy 2022 (WVA-2022) codes that generalize ICD-10 codes into mortality relevant codes.
...
* **Dimensions**: 3 columns / 65 rows', 'main', 'support@openmortality.org', '3', '65'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to WVA-2022 Code Mappings', 'icd10_wva2022_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.568348-04:00', 'published', 'icd,wva', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) to [WVA-2022](https://openmortality.org/data/wva2022_v1).
...
* **Dimensions**: 4 columns / 4,442 rows', 'supplementary', 'support@openmortality.org', '4', '4442'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'CGHR-10 Codes', 'cghr10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.568670-04:00', 'published', 'cghr', 'Centre for Global Health Research for ICD-10 (CGHR-10) codes for physician coded verbal autopsies.
...
* **Dimensions**: 3 columns / 36 rows', 'main', 'support@openmortality.org', '3', '36'
            ...
            INSERT INTO public.dp_data (title, data_name, "format", is_spatial, "permission", publish_date, status, tag, data_desc, category, contact, data_columns, data_rows)
            SELECT 'ICD-10 to CGHR-10 Code Mappings', 'icd10_cghr10_v1', 'csv', 'False', 'user', '2023-07-11 23:48:06.569019-04:00', 'published', 'icd,cghr', 'Mappings to convert from [ICD-10](https://openmortality.org/data/icd10_v1) codes to [CGHR-10](https://openmortality.org/data/cghr10_v1) codes.
