...
CREATE TABLE IF NOT EXISTS public.dp_dataset (
    ...
    permission VARCHAR
        ...
        SET
            ...
            title_abbr = 'icd',
            status = 'published',
            data_id = '236,231,232,233,234,235,239,245,240,241,237,238,242,243,244',
            contact = 'support@openmortality.org',
            publish_date = '2023-08-16 15:41:23.382269-04:00',
...
',
        ...
        SELECT 'ICD Codes and Mappings', 'icd', 'published', '236,231,232,233,234,235,239,245,240,241,237,238,242,243,244', 'support@openmortality.org', '2023-08-16 15:41:23.382269-04:00', 'icd,wbd,cmea,wva,cghr', 'ICD-related codes and mappings used at CGHR.
