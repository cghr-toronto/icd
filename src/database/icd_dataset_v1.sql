...
CREATE TABLE IF NOT EXISTS public.dp_dataset (
    ...
    permission VARCHAR
        ...
        SELECT 'ICD Codes and Mappings', 'icd', 'published', '231,232,233,234,235,236,237,238,239,240,241,242,243,244', 'support@openmortality.org', '2023-06-16 03:26:26.767466-04:00', 'icd,wbd,cmea,wva,cghr', 'ICD-related codes and mappings used at CGHR.
