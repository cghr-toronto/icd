...
CREATE TABLE IF NOT EXISTS public.dp_dataset (
    ...
    permission VARCHAR
        ...
        SET
            ...
            title_abbr = 'icd',
            status = 'published',
            data_id = '236,231,232,233,234,235,239,240,241,242,237,238,243,244',
            contact = 'support@openmortality.org',
            publish_date = '2023-07-11 23:48:06.722286-04:00',
...
',
        ...
        SELECT 'ICD Codes and Mappings', 'icd', 'published', '236,231,232,233,234,235,239,240,241,242,237,238,243,244', 'support@openmortality.org', '2023-07-11 23:48:06.722286-04:00', 'icd,wbd,cmea,wva,cghr', 'ICD-related codes and mappings used at CGHR.
