...
CREATE OR REPLACE VIEW wbd10xicd10 AS (SELECT * FROM wbd10xicd10_v1);
...
COMMENT ON COLUMN wbd10xicd10.wbd10_age IS 'Age group for the WBD entity.';
COMMENT ON COLUMN wbd10xicd10.wbd10_kind IS 'WBD entity kind. One of codex4, codex2, or codex. Codex4 are top level classification entities, codex2 are high level groupings, and codex are the WBD codes at the lowest level.';
COMMENT ON COLUMN wbd10xicd10.wbd10_kind_depth IS 'WBD depth for kind. For example, a codex with kind_depth=3 means means it has 2 higher levels above it. Codex4 has depth of 1 (highest) and Codex2 has depth of 2 (middle).';
COMMENT ON COLUMN wbd10xicd10.wbd10_codex4 IS 'WBD codex4 - a higher level classification of the WBD codes.';
COMMENT ON COLUMN wbd10xicd10.wbd10_codex2 IS 'WBD codex2 - a middle level classification that usually group several WBD codes together.';
COMMENT ON COLUMN wbd10xicd10.wbd10_code IS 'WBD codex or codes - the lowest level classification representing the WBD codes themselves.';
COMMENT ON COLUMN wbd10xicd10.wbd10_codex4_title IS 'WBD title for codex4.';
COMMENT ON COLUMN wbd10xicd10.wbd10_codex2_title IS 'WBD title for codex2.';
