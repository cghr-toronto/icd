...
COMMENT ON COLUMN wbd10_v1.age IS 'Age group for the WBD entity - adult (12-69 years old), child (1 month to 11 years old), and neo (under 1 month old).';
...
COMMENT ON COLUMN icd10towbd10_v1.wbd10_age IS 'Age group for the WBD entity - adult (12-69 years old), child (1 month to 11 years old), and neo (under 1 month old).';
...
COMMENT ON TABLE wva2016_v1 IS 'World Health Organization (WHO) Verbal Autopsy (VA) 2016 codes for International Classification of Diseases (ICD) Revision 10 codes. See https://github.com/cghr-toronto/icd for more details.';
...
--- icd10towva2022_v1 table comment
COMMENT ON TABLE icd10towva2022_v1 IS 'Mappings for each individual International Classification of Diseases (ICD) Revision 10 code from the World Health Organization (WHO) to WHO Verbal Autopsy (VA) 2022 codes. See https://github.com/cghr-toronto/icd for more details.';

--- icd10towva2022_v1 column comments (n=4)
COMMENT ON COLUMN icd10towva2022_v1.wva2022_code IS 'WHO VA code from the 2022 WHO VA instrument.';
COMMENT ON COLUMN icd10towva2022_v1.wva2022_title IS 'Title for the WHO VA 2022 code.';
COMMENT ON COLUMN icd10towva2022_v1.icd10_range IS 'Range of ICD-10 codes for the WHO VA 2022 codes.';
COMMENT ON COLUMN icd10towva2022_v1.icd10_code IS 'ICD-10 code for the WHO VA 2022 code.';

--- wva2022_v1 table comment
COMMENT ON TABLE wva2022_v1 IS 'World Health Organization (WHO) Verbal Autopsy (VA) 2022 codes for International Classification of Diseases (ICD) Revision 10 codes. See https://github.com/cghr-toronto/icd for more details.';

--- wva2022_v1 column comments (n=3)
COMMENT ON COLUMN wva2022_v1.wva2022_code IS 'WHO VA code from the 2022 WHO VA instrument.';
COMMENT ON COLUMN wva2022_v1.wva2022_title IS 'Title for the WHO VA 2022 code.';
COMMENT ON COLUMN wva2022_v1.icd10_range IS 'Range of ICD-10 codes for the WHO VA 2022 codes.';

--- cghr2019_v1 table comment
COMMENT ON TABLE cghr2019_v1 IS 'Centre for Global Health Research (CGHR) 2019 codes for physician coded verbal autopsies. See https://github.com/cghr-toronto/icd for more details.';

--- cghr2019_v1 column comments (n=3)
COMMENT ON COLUMN cghr2019_v1.code IS 'CGHR 2019 code.';
COMMENT ON COLUMN cghr2019_v1.title IS 'CGHR 2019 title for the code.';
COMMENT ON COLUMN cghr2019_v1.age IS 'CGHR 2019 code age group. Age groups are divided into adult (12 to 69 years old), child (1 month to 11 years old), and neo (under 1 month old).';

--- cghr2019towbd10_v1 table comment
COMMENT ON TABLE cghr2019towbd10_v1 IS 'Mappings from the Centre for Global Health Research (CGHR) 2019 codes to Wilson''s Burden of Disease (WBD) 10 codes. See https://github.com/cghr-toronto/icd for more details.';

--- cghr2019towbd10_v1 column comments (n=9)
COMMENT ON COLUMN cghr2019towbd10_v1.cghr2019_code IS 'CGHR 2019 code.';
COMMENT ON COLUMN cghr2019towbd10_v1.cghr2019_title IS 'CGHR 2019 title for the code.';
COMMENT ON COLUMN cghr2019towbd10_v1.cghr2019_age IS 'CGHR 2019 code age group. Age groups are divided into adult (12 to 69 years old), child (1 month to 11 years old), and neo (under 1 month old).';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_codex4 IS 'WBD codex4 - a higher level classification of the WBD codes.';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_codex2 IS 'WBD codex2 - a middle level classification that usually group several WBD codes together.';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_code IS 'WBD codex or codes - the lowest level classification representing the WBD codes themselves.';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_codex4_title IS 'WBD title for codex4.';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_codex2_title IS 'WBD title for codex2.';
COMMENT ON COLUMN cghr2019towbd10_v1.wbd10_title IS 'WBD code/codex title.';

--- wva2016tocghr2019_v1 table comment
COMMENT ON TABLE wva2016tocghr2019_v1 IS 'Mappings from the World Health Organization (WHO) Verbal Autopsy (VA) 2016 codes to the Centre for Global Health Research (CGHR) 2019 codes. See https://github.com/cghr-toronto/icd for more details.';

--- wva2016tocghr2019_v1 column comments (n=4)
COMMENT ON COLUMN wva2016tocghr2019_v1.wva2016_code IS 'WHO VA code from the 2016 WHO VA instrument.';
COMMENT ON COLUMN wva2016tocghr2019_v1.cghr2019_code IS 'CGHR 2019 code.';
COMMENT ON COLUMN wva2016tocghr2019_v1.cghr2019_title IS 'CGHR 2019 title for the code.';
COMMENT ON COLUMN wva2016tocghr2019_v1.cghr2019_age IS 'CGHR 2019 code age group. Age groups are divided into adult (12 to 69 years old), child (1 month to 11 years old), and neo (under 1 month old).';

--- wva2016towbd10_v1 table comment
COMMENT ON TABLE wva2016towbd10_v1 IS 'Mappings from the World Health Organization (WHO) Verbal Autopsy (VA) 2016 codes to Wilson''s Burden of Disease (WBD) 10 codes. See https://github.com/cghr-toronto/icd for more details.';

--- wva2016towbd10_v1 column comments (n=8)
COMMENT ON COLUMN wva2016towbd10_v1.wva2016_code IS 'WHO VA code from the 2016 WHO VA instrument.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_codex4 IS 'WBD codex4 - a higher level classification of the WBD codes.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_codex2 IS 'WBD codex2 - a middle level classification that usually group several WBD codes together.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_code IS 'WBD codex or codes - the lowest level classification representing the WBD codes themselves.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_codex4_title IS 'WBD title for codex4.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_codex2_title IS 'WBD title for codex2.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_title IS 'WBD code/codex title.';
COMMENT ON COLUMN wva2016towbd10_v1.wbd10_age IS 'Age group for the WBD entity - adult (12-69 years old), child (1 month to 11 years old), and neo (under 1 month old).';