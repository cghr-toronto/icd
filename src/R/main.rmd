...
wbdxicd10 <- wbd %>% filter(kind == "codex")

# Expand ICD ranges
wbdxicd10 <- expandICD10Data(
  wbdxicd10,
...
```{r}
write_csv(ddict, "../data/wbd_raw_ddict.csv", na="")
write_csv(wbd, "../data/wbd_raw.csv", na="")
write_csv(wbdxicd10, "../data/wbdxicd10_raw.csv", na="")
```
