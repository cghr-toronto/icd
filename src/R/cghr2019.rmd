...
cghrtowbd10n$age <- "neo"

# Combine all age groups
cghrtowbd10 <- rbind(cghrtowbd10a, cghrtowbd10c, cghrtowbd10n) %>% 
  arrange(cghr_code) %>%
  rename(cghr_title = cghr_label)
cghrtowbd10
```
...
wva2016tocghra <- subset(wva2016tocghra, select=c(wva2016_code, cghr_code, cghr_label))
wva2016tocghra <- wva2016tocghra[!duplicated(wva2016tocghra$wva2016_code),]
wva2016tocghra$age <- "adult"

# Prepare child
wva2016tocghrc <- read_csv("../data/wva2016tocghr_neo.csv", show_col_types=FALSE)
wva2016tocghrc <- subset(wva2016tocghrc, select=c(wva2016_code, cghr_code, cghr_label))
wva2016tocghrc <- wva2016tocghrc[!duplicated(wva2016tocghrc$wva2016_code),]
wva2016tocghrc$age <- "child"

# Prepare neo
wva2016tocghrn <- read_csv("../data/wva2016tocghr_neo.csv", show_col_types=FALSE)
wva2016tocghrn <- subset(wva2016tocghrn, select=c(wva2016_code, cghr_code, cghr_label))
wva2016tocghrn <- wva2016tocghrn[!duplicated(wva2016tocghrn$wva2016_code),]
wva2016tocghrn$age <- "neo"

# Combine all age groups
wva2016tocghr <- rbind(wva2016tocghra, wva2016tocghrc, wva2016tocghrn) %>% 
