...
For public access, [download](https://github.com/cghr-toronto/icd/archive/refs/heads/main.zip) the entire repository as a zip file, unzip the downloaded zip, and find the data files in the [data](data).
